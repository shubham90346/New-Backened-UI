          ...
          <div className='col-lg-2'>
            <div className='container ' >
              <ul className="list-group mt-1" >
                <li className="t5 trtt " onClick={() => IsActive(1)} style={active === 1 ? { backgroundColor: 'rgb(224,243,255)' } : { color: 'rgb(65,84,241)' }}>
                  <AiOutlineRocket className='t1' />
                  Dashboard</li>

                <li className="t5" onClick={() => IsActive(2)} style={active === 2 ? { backgroundColor: 'rgb(224,243,255)' } : { color: 'rgb(56,87,143)' }}>
                  <LiaAddressCardSolid className='t1' />
                  Sales Report
                </li>          <li className="t5" onClick={() => IsActive(3)} style={active === 3 ? { backgroundColor: 'rgb(224,243,255)' } : { color: 'rgb(56,87,143)' }}>
                  <LiaAddressCardSolid className='t1' />
                  Comparison Report
                </li>

                <li className="t5" onClick={() => IsActive(4)} style={active === 4 ? { backgroundColor: 'rgb(224,243,255)' } : { color: 'rgb(56,87,143)' }}>
                  <LiaAddressCardSolid className='t1' />
                  Items Report
                </li>

                <li className="t5" onClick={() => IsActive(5)} style={active === 5 ? { backgroundColor: 'rgb(224,243,255)' } : { color: 'rgb(56,87,143)' }}>
                  <LiaAddressCardSolid className='t1' />
                  Cogs Report
                </li>
              </ul>
